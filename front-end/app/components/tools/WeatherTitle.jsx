...
export default function WeatherTitle() {
  return (
    <div className="flex flex-col items-center justify-center mt-24 mb-16">
      <h1
        className="text-4xl md:text-6xl text-center font-bold bg-gradient-to-r mb-8 from-blue-500 to-purple-500 bg-clip-text text-transparent " id="wheater"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <p
        className="text-lg mx-6 md:text-xl text-center max-w-[50rem] :text-gray-300 mb-8"
      >
